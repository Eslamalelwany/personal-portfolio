...
useEffect(() => {
    ...
    />
            ...
            <a target="_blank"  href="https://drive.google.com/file/d/1gKga_RUesL9oRs0kDD6PnDRuUqHBVeyX/view"  className="bg-[#132440] p-3  font-extralight mr-auto  cursor-pointer mt-3 text-white rounded-xl text-sm animate-pulse">Download CV</a>
            </div>
        </div>
    )
}